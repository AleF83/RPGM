...
export const entityListSuccess = entities => ({
  type: ENTITY_LIST_SUCCESS,
  entities,
});

export const entityListFailure = message => ({
  type: ENTITY_LIST_FAILURE,
  message,
});

export const entityLoadRequest = entityId => ({
  type: ENTITY_LOAD_REQUEST,
  entityId,
});

export const entityLoadSuccess = entity => ({
  type: ENTITY_LOAD_SUCCESS,
  entity,
});

export const entityLoadFailure = message => ({
...
export const entityCreateSuccess = entity => ({
  type: ENTITY_CREATE_SUCCESS,
  entity,
});

export const entityCreateFailure = message => ({
  type: ENTITY_CREATE_FAILURE,
  message,
});
...
export const entityUpdateFailure = message => ({
  type: ENTITY_UPDATE_FAILURE,
  message,
});

export const entityDeleteRequest = entityId => ({
  type: ENTITY_DELETE_REQUEST,
  entityId,
});

export const entityDeleteSuccess = entityId => ({
